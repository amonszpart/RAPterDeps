...
OLGA_INLINE void GCoptimization::addterm2_checked(EnergyT* e, VarID i, VarID j, EnergyTermType e00, EnergyTermType e01, EnergyTermType e10, EnergyTermType e11, EnergyTermType w)
{
	...
	if ( e00+e11 > e01+e10 )
    {
        std::cout << "e00: " << e00 << ", e11: " << e11 << ", e00+e11: " << e00 + e11
                  << ", e01: " << e01 << ", e10: " << e10 << ", e01+e10: " << e01 + e10 << std::endl;
...
bool GCoptimization::alpha_expansion(LabelID alpha_label)
{
	...
	try 
	{
        ...
        EnergyT e( /*        node_count: */   size + m_labelcostCount // poor guess at number of pairwise terms needed :(
                   /*        edge_count: */ , m_numNeighborsTotal + (m_labelcostCount?size+m_labelcostCount : 0)
                   /* f_err_msg_handler: */ , (void(*)(char*))handleError );
        e.add_variable( size );
...
GCoptimization::SiteID GCoptimization::DataCostFnSparse::queryActiveSitesExpansion(LabelID alpha_label, const LabelID* labeling, SiteID* activeSites)
{
	...
	SiteID count = 0;
    for (; next != end; ++next) // Aron: changed to != from <
    {
