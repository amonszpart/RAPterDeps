...
//#include <sstream>
//class IllegalEnergyException : public std::exception
//{
//    public:
//        IllegalEnergyException( std::string const& msg )
//            : _message( msg ) {}
//        virtual ~IllegalEnergyException() _GLIBCXX_USE_NOEXCEPT;

//        // See comment in eh_exception.cc.
//        std::string why() const {
//            std::stringstream ss;
//            ss << "IllegalEnergyException: " << _message << std::endl;
//            return ss.str();
//        }
//    protected:
//        std::string _message;
                                                         ...
                                                         Value C, Value D)
{
    ...
    */
    ...
    if ( B+C < 0 ) throw new std::runtime_error( "assert B+C>=0" );
